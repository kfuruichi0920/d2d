...
const api: D2DApi = {
  ...
  llm: {
    ...
    createProvider: (opts) => ipcRenderer.invoke('llm:createProvider', opts),
    updateProvider: (uid, fields) => ipcRenderer.invoke('llm:updateProvider', uid, fields),
    deleteProvider: (uid) => ipcRenderer.invoke('llm:deleteProvider', uid),
    run: (opts) => ipcRenderer.invoke('llm:run', opts),
    listLogs: (limit) => ipcRenderer.invoke('llm:listLogs', limit),
    logStats: () => ipcRenderer.invoke('llm:logStats'),
    seedBuiltins: () => ipcRenderer.invoke('llm:seedBuiltins'),
    listTemplates: () => ipcRenderer.invoke('llm:listTemplates'),
    getTemplate: (uid) => ipcRenderer.invoke('llm:getTemplate', uid),
    createTemplate: (opts) => ipcRenderer.invoke('llm:createTemplate', opts),
    addTemplateVersion: (templateUid, opts) => ipcRenderer.invoke('llm:addTemplateVersion', templateUid, opts),
    getLatestVersion: (templateUid) => ipcRenderer.invoke('llm:getLatestVersion', templateUid),
    listVersions: (templateUid) => ipcRenderer.invoke('llm:listVersions', templateUid),
    deleteTemplate: (uid) => ipcRenderer.invoke('llm:deleteTemplate', uid),
    renderTemplate: (template, variables) => ipcRenderer.invoke('llm:renderTemplate', template, variables),
    listCandidates: (opts) => ipcRenderer.invoke('llm:listCandidates', opts),
    getCandidate: (uid) => ipcRenderer.invoke('llm:getCandidate', uid),
    reviewCandidate: (uid, status, modifiedJson) => ipcRenderer.invoke('llm:reviewCandidate', uid, status, modifiedJson),
