...
| 領域 | 必須情報 | 主な対応先 |
| --- | --- | --- |
| 文書メタデータ | ファイル名、スライド数、slide_width、slide_height、抽出器名、抽出器バージョン、原本ハッシュ | `extracted_document.structure_json.metadata`、`resource_metadata` |
| スライド | slide_no、title、status、notes、element_ids、overview_blob_uid、警告、要素数サマリー | `structure_json.slides`、`extracted_item`、`source_location` |
