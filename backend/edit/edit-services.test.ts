...
describe('P10 編集機能', () => {
  ...
  it('マイグレーション 1.2.0: 新規 DB は最新版で resource_table_cell を持つ（TBD-04）', () => {
    expect(LATEST_SCHEMA_VERSION).toBe('1.2.0')
  ...
  it('マイグレーション: 1.0.0 の既存 DB を開くと 1.2.0 へ移行しバックアップを作る', () => {
    ...
    expect(getSchemaVersion(migrated)).toBe('1.2.0')
