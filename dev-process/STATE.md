...
| P5-20B                     | PDFオーバーレイレビューEditor: pdf-draft://、ページ画像+候補オーバーレイ、ズーム/ページ切替、ドラッグ追加・移動・リサイズ、種別/採否/読み順/bbox編集、表セル編集+領域再解析、図CSS切出しプレビュー、一括採否、原本/ステージ導線（Unit 312／E2E 34）                                                                          | （本コミット）  |
