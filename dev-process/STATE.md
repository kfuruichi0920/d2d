...
| P5-20A                     | PDF物理抽出・領域候補ドラフト: extract.pdf／extract.pdf.region（pdfplumber+pypdfium2、AGPL排除・TBD-01改定）、schema 2.5.0 `pdf_extraction_draft`、ルール候補（見出し/本文/リスト/表+セル/図/キャプション/ヘッダ等既定不採用）、読み順推定、pdfDraft API 4種（Unit 312／pytest 30／E2E 33）                                  | （本コミット）  |
