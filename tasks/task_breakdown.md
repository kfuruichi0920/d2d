...
| P9-4 | 汎用トレースマトリクスEditor             | 設計分類／②文書／③成果物／Resource種別から複数Resource集合を行列へ配置し、複数関係種別の色分け表示、転置、固定見出し、ズーム、Tooltip、十字強調、行／列／セル複数選択、方向指定による単一トグル・一括追加／論理削除を提供する | P9-1, P3-4, P8-2 | [UI-014, TRACE-026〜029]                      |
| P9-5 | 汎用インパクト分析ビュー                 | 任意の複数Resource集合を持つ列を左右へ追加し、方向・関係種別を識別するリンク、複数選択から全列への連鎖強調、関連項目限定表示、階層折畳と親リンク集約、Tooltip、表示領域限定リンク描画を提供する | P9-1, P3-4 | [UI-015, TRACE-030〜034]                      |
