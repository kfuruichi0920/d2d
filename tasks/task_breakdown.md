...
| P5-19 | Excel抽出候補フロー | `extract.excel`: `.xlsx` の物理抽出、ルールによる抽出グループ候補生成、Workbenchでの範囲・種別・タイトル・採否編集、選択範囲限定LLM支援、確定候補から既存②抽出データへの変換を実装する。詳細と後続フェーズは `tasks/P5-19-excel-extraction.md` を正とする | P5-7, P5-6, P6 | [IMP-002, EXT-009, EXT-049〜055, sdd_excel_extraction] |
