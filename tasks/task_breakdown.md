...
| P7-5 | チャンク管理                     | 成果物単位の3ペインチャンク編集、chunk / chunk_item CRUD、確認済みintermediate_itemとの多対多選択、chunk→intermediate_itemのitem単位based_on、追加プロンプト保持、範囲の相互強調、親子関係なし・一時単位の徹底                              | P7-1       | [MID-030〜034]                                                         |
