...
| P5-15 | 抽出データビュー                 | ②抽出データの一覧・閲覧、原本ファイル名を初期名称とする表示名称変更、一覧／プレビュー2ペインの境界リサイズ、文書プレビュー／色付き階層 structure_json 表示切替（形式非依存の共通ビュー）                                                                                                                                                                                                                                                                                                                                                                                 | P3-4, P5-2        | [UI-011, EXT-040, UI-044〜045]                                                                   |
