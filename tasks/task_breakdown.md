...
| P5-19 | Excel抽出候補フロー | `extract.excel`: `.xlsx` の物理抽出、ルール候補、シートプレビュー上の編集可能オーバレイ、任意範囲LLMグルーピング、DrawingML図・装飾、再取込差分・候補UID継承、確定候補から既存②抽出データへの変換を実装する。詳細は `tasks/P5-19-excel-extraction.md` を正とする | P5-7, P5-6, P6 | [IMP-002, EXT-009, EXT-049〜062, sdd_excel_extraction] |
