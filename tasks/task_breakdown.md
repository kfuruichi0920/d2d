...
| P4-2 | 原本ビュー     | 取込済み原本のソート可能な一覧と読取専用詳細、Windows関連付けアプリでのファイル表示、一覧上部からの複数原本取込、一覧からの論理削除・アーカイブ／復元、Explorer ①〜④見出しの強調・折りたたみ、各データ行のプロパティTooltip                                                                                                                                                                     | P3-2, P4-1       | [UI-010, UI-044〜047]                   |
