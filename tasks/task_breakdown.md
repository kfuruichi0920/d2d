...
| P10-7 | セマンティック入力支援     | 表示文／原文／構造化参照／正規化履歴の分離、辞書・モデル・最近使用の前方一致補完、既存文解析、形態素／LLM／手入力の用語候補、承認制御、表示方法、構造化直接編集検証、Secondary Dictionary、Resource Editorからの検査済みtrace生成 | P8-1, P8-2, P10-6, P11-1 | [EDIT-057〜071, LLM-036]                 |
