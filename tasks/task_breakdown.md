...
| P3-7 | Pipeline Navigator・Perspective                 | ①〜④ステージナビゲーション、作業モード（M1〜M5）切替、各ステージ一覧Editor（①原本、②抽出、③フェーズ－成果物、④モデル）への遷移、現在ステージだけの選択表示、列ソート、行のクリック／上下キー／Enter／Space操作、①～③の一覧／プレビュー境界リサイズ、①取込・③取込・④追加操作の一覧上部配置、Explorerのプロジェクト名をルートとするVS Code風単一Tree／Resource別ファイルアイコン・右端タグ表示、指定フォルダ／成果物だけの右クリック取込                                                                                                              | P3-2       | [UI-046〜048, sdd_ui_design §3.1, §5, §6]                                       |
